...
public class CostsAscendWeaponAdapter extends RecyclerView.Adapter<CostsAscendWeaponAdapter.CostsAscendWeaponViewHolder> {

    private final Context context;
    private final ArrayList<ItemCostsAscend> array;

    public CostsAscendWeaponAdapter(Context context, ArrayList<ItemCostsAscend> array) {
    ...
    @NonNull
    @Override
    public CostsAscendWeaponViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_costs_ascend, parent, false);
        return new CostsAscendWeaponViewHolder(v);
    }

    @SuppressLint("NotifyDataSetChanged")
    @Override
    public void onBindViewHolder(@NonNull CostsAscendWeaponViewHolder holder, int position) {
    ...
    static class CostsAscendWeaponViewHolder extends RecyclerView.ViewHolder{
        ...
        public CostsAscendWeaponViewHolder(@NonNull View itemView) {
            super(itemView);
